...
import com.springbatch.project.springbatch.repository.booking.BookingRepository;
...
public class UsePassesJobConfig {
    ...
    public JpaCursorItemReader<BookingEntity> usePassesItemReader() {
        return new JpaCursorItemReaderBuilder<BookingEntity>()
                ...
                // 상태가 완료상태이며, 종료 일시가 과거인 예약이 이용권 차감 대상
    ...
    // 이 프로젝트에서는 간단한 작업이라 적합하지 않지만, ItemProcessor의 수행이 오래걸려 병목이 생기는 경우에 AsyncItemProcessor, AsyncItemWriter를 사용하면 성능이 향상
    @Bean
